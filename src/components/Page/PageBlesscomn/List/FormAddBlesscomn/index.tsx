...
import { Typography, IconButton, Input, Select, Option, Textarea } from '@material-tailwind/react'
        ...
        <div className='relative p-8 h-full grid grid-rows-12 '>
            ...
            <form className="flex flex-col gap-6 p-4  overflow-auto h-full row-span-10">
                ...
                <div>
                    ...
                    <SelectFilter options={options} className='' styles={{ control: (style) => ({ ...style, padding: "0.25rem", borderRadius: "0.375rem", borderColor: "gray" }) }} />
                    {/* {errors.usernameOrEmail && <div className="text-red-500 text-sm">{errors.usernameOrEmail.message}</div>} */}
                </div>
                <div>
                    <Typography variant="small" color="blue-gray" className="mb-1 font-medium capitalize" >
            ...
            <div className='absolute flex gap-6 bottom-0 right-0 p-8'>
                ...
                <IconButton className='bg-[#2186A4]/20 p-6 rounded-full'>
